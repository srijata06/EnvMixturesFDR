#' Identify important exposures and estimate their effects using knockoffs.
#'
...
#' at a given threshold. The method is based on the knockoffs approach.
#' 
    ...
    for (g2 in 1 : (g1 - 1)) {
      ...
      for (m1 in 1 : mg) {
        for (m2 in 1 : mg) {
          ...
          designX[,counter2] = stats::lm(tempY ~ tempX1 + tempX2)$residuals
          counter2 = counter2 + 1
        }
      }
